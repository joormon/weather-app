...
export default function InfoBox({weatherInfo}) 
{
    ...
    const image = weatherInfo.humidity > 70
        ? URL_rainy
        ...
        <Card sx={{ maxWidth: 200 }}>
                ...
                <CardContent>
                    ...
                    <Typography component="div" variant="body2" sx={{ color: 'text.secondary' }}>
                       <div><p>Weather: {weatherInfo.weather}</p></div>
                       <div><p>Temp: {weatherInfo.temp}</p></div>
                       <div><p>Max-Temp:{weatherInfo.temp_max}</p></div>
                       <div><p>Min-Temp:{weatherInfo.temp_min}</p></div>
                    </Typography>
                </CardContent>
        </Card>
    );
